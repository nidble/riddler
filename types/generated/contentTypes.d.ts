...
export interface ApiModuleItemModuleItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answers: Schema.Attribute.Component<'shared.row', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    type: Schema.Attribute.Enumeration<
      ['multiple-choice', 'grid-multiple-choice']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    module_items: Schema.Attribute.Relation<
      'manyToMany',
      'api::module-item.module-item'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiQuizItemQuizItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    module_item: Schema.Attribute.Relation<
      'oneToOne',
      'api::module-item.module-item'
    >;
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quiz_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::quiz-item.quiz-item'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::module-item.module-item': ApiModuleItemModuleItem;
